...
module.exports = {
  ...
  description: "Blacklist somebody from the bot owner only command!",
  ...
  let prefix = await db.fetch(`prefix_${message.guild.id}`)
   if(prefix == null) {
    ...
    if (message.author.id != 732378437762678836) return message.reply("you do not have permission to use this command!")
